/*! it-framework - MIT
Version	: 1.0.2 
Build	: 2017-11-22 09:53:44 
Author	: Kami Technical <kamitechnical@gmail.com>
*/
var IT = IT || {};

if (null == base_url) var base_url = window.location.protocol + "//" + window.location.host;

var base_events = [ "blur", "change", "click", "dblclick", "focus", "hover", "keydown", "keypress", "keyup", "show", "hide" ], transitionEnd = "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", animationEnd = "webkitAnimationEnd oanimationend msAnimationEnd animationend";
...
!function(t) {
    ...
    getSelectedRecords() {
        return this.selectedRow ? this.store.data[this.selectedRow] : null;
    }
    addRow(t = {}) {
        let e = this, n = $("<tr>");
    ...
    constructor(t) {
        ...
        e.ids = [], e.items = {}, $.each(e.settings.items, function(t, i) {
            i && (i.isClass || (i = IT.Utils.createObject(i)), i.noRow ? i.renderTo(s) : (n = $("<div/>", {
                class: "row form-row"
            }), i.renderTo(n), s.append(n)), e.ids.push(i.getId()), e.items[i.getId()] = i);
        }), e.content = $("<form />", {
            name: IT.Utils.id(),
            class: "it-form",
