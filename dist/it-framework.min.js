...
Array.prototype.remove = function(t, e) {
    ...
    return t && $.extend(e, t), this.each(function() {
        ...
        if (!0 !== t.data("ajaxUploader-setup")) {
            t.change(function() {
                n = !1, null == e.submit_button && s();
            }), null == e.submit_button || e.submit_button.click(function() {
                n || s();
            });
            var s = function() {
                if ("" == t.val()) return e.onCancel.apply(t, [ e.params ]);
                var s = t.val().split(".").pop().toLowerCase();
                -1 == $.inArray(s, e.valid_extensions) ? e.onComplete.apply(t, [ {
                    status: !1,
                    message: "The select file type is invalid. File must be " + e.valid_extensions.join(", ") + "."
                }, e.params ]) : (n = !0, a(t), !1 !== e.onStart.apply(t) && t.parent("form").submit(function(t) {
                    t.stopPropagation();
                }).submit());
            };
            t.data("ajaxUploader-setup", !0);
            var i = function(t, s) {
                var i, a = t.contentWindow.document.body.innerHTML;
                try {
                    i = JSON.parse(a);
                } catch (t) {
                    i = a;
                }
                s.siblings().remove(), s.unwrap(), n = !1, e.onComplete.apply(s, [ i, e.params ]);
            }, a = function(t) {
