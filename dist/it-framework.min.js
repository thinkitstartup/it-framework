...
IT.BaseClass = class {
    ...
    doEvent(t, e, n = null) {
        var a = this;
        if ("function" == typeof a[t]) return a[t].apply(n || a, e);
    }
    ...
    constructor(t) {
        ...
        e.params = {}, e.selectedRow = null, e.selectedColumn = null, e.paging = {
            ...
            onEmpty: function(t, n, a) {
                e.assignData(t), e.doEvent("onLoad", [ e, t ]), e.content.find(".it-datatable-loading-overlay").removeClass("loading-show");
            }
    ...
    createComponent() {
        ...
        if (t.content.append(n.append(s.append(i))), e.customHeader) i.append($(e.customHeader)); else {
            let t, n = $(`<tr/>`);
            for (let a = 0; a < e.columns.length; a++) t = e.columns[a], n.append($(`<th />`, {
                css: {
                    "min-width": t.width,
                    width: t.width
                }
    ...
    assignData(t) {
        ...
        n.length) for (let t = 0; t < n.length; t++) {
            ...
            for (let n = 0; n < e.settings.columns.length; n++) {
                let i = e.settings.columns[n], o = e.settings.columns[n].dataIndex, l = a.get(o);
                l = l || "";
                let d, r = $("<td />", {
                    html: $("<div />", {
                        html: l
                ...
                r.on("click", function() {
                    ...
                    r.find("div").empty(), d.input.on("blur", function() {
                        d.validate() && (a.update(o, d.val()), r.removeClass("it-datatable-editing"), r.find("div").html(d.val()), 
