...
IT.BaseClass = class {
    ...
    addEvents(t, e = []) {
        let n = this;
        e.forEach(e => n[e] = t[e] || function() {});
    }
    doEvent(t, e, n = null) {
        var s = this;
        if ("function" == typeof s[t]) return s[t].apply(n || s, e);
    }
    ...
    constructor(t) {
        ...
        e.settings = $.extend(!0, {
            ...
            columns: [ {} ],
            customHeader: ""
        }, t), e.id = e.settings.id || IT.Utils.id(), e.addEvents(e.settings, [ "onItemClick", "onItemDblClick", "onLoad", "onChangePage" ]), 
        e.params = {}, e.selectedRow = null, e.selectedColumn = null, e.paging = {
            ...
            afterLoad: function(t, n, s) {
                e.assignData(t), e.doEvent("onLoad", [ e, t ]);
            },
    ...
    constructor(t) {
        ...
        e.settings = $.extend(!0, {
            ...
            class: "it-edit"
        }), e.content.append(e.select), e.select.selectize(e.settings.selectize), e.settings.width && e.content.css({
            width: e.settings.width
        }), e.settings.autoLoad && e.getDataSource(), e.addEvents(e.settings, [ "onChange" ]);
    }
    val(t) {
    ...
    getDataSource() {
        ...
        n.clear();
        switch (console.info(n), t.settings.emptyText && t.getSelect().addOption({
            value: "",
          ...
          case "ajax":
            $.ajax({
                ...
                success: function(t) {
                    var e = t.rows;
                    void 0 !== e && e.length > 0 && $.each(e, function(t, e) {
                        n.addOption({
                            value: e.key,
                            text: e.value,
                            params: void 0 !== e.params ? JSON.stringify(e.params) : ""
    ...
    constructor(t) {
        ...
        }, t), e.params = e.settings.params, e.data = [], e.total_rows = 0, e.addEvents(e.settings, [ "beforeLoad", "afterLoad", "onLoad", "onError", "onEmpty" ]), 
        ...
        switch (e.settings.type) {
          case "json":
            ...
            e.params = n, e.empty(), $.ajax({
                ...
                success: function(t) {
                    ...
                    }), e.total_rows = t.total_rows, e.doEvent("onLoad", [ e, e.getData(), e.params ])) : (e.empty(), 
                    e.doEvent("onError", [ e, {
                        status: !1,
          ...
          case "array":
            ...
            void 0 === s || s ? (void 0 !== e.settings.data ? ($.each(e.settings.data, (t, n) => {
                ...
                status: !1,
                message: "Data JSON '" + e.settings.url + "' Tidak Ditemukan"
            } ]), e.doEvent("afterLoad", [ e, e.getData() ])) : (e.empty(), e.doEvent("onError", [ e, {
                status: !1,
                message: "Format Data Tidak Sesuai"
            } ]));
        }
