...
IT.BaseClass = class {
    ...
    createComponent() {
        ...
        if (t.content.append(n.append(s.append(i))), e.customHeader) i.append($(e.customHeader)); else {
            ...
            }).append(n.header)), t.editors.push(n.editor ? IT.Utils.createObject(n.editor) : null);
            i.append(a);
        }
    ...
    assignData(t) {
        ...
        n.length) for (let t = 0; t < n.length; t++) {
            ...
            for (let n = 0; n < e.settings.columns.length; n++) {
                let i = e.settings.columns[n], o = e.settings.columns[n].dataIndex, l = a.get(o), d = "", r = i.data || i.renderer || (e.editors[n] && e.editors[n].store ? e.editors[n].store.getRawData() : null) || [];
                ...
                c.on("click", function() {
                    if (e.selectedRow = t, e.selectedColumn = n, e.content.find("tbody tr").removeClass("it-datatable-selected"), 
                    $(this).parent().addClass("it-datatable-selected"), i.editor && i.editor.editable && !$(this).hasClass("it-datatable-editing")) {
                        c.addClass("it-datatable-editing");
                        let t = e.editors[n], s = a.getChanged(o) || a.get(o);
                        t.val(s), c.find("div").empty(), t.input.on("blur", function() {
                            if (t.validate()) {
                                a.update(o, t.val());
                                let e = a.getChanged(o) || a.get(o);
                                t.input.off(), t.content.detach(), c.removeClass("it-datatable-editing"), c.find("div").html(e), 
                                c[a.isChanged(o) ? "addClass" : "removeClass"]("it-datatable-changed");
                            }
                        }), t.renderTo($(this).find("div")), t.input.focus();
                    }
                }), s.append(c);
            }
