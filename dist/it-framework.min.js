...
IT.BaseClass = class {
    ...
    createComponent() {
        ...
        let n = $(`<div class="it-datatable-wrapper"/>`), s = $(`<div class="it-datatable-fixed-header"/>`), i = $(`<table width='${e.width}' height='${e.height}'/>`), a = $(`<thead/>`), o = $(`<tbody/>`);
    ...
    assignData(t) {
        ...
        if (t && t.rows) {
            ...
            e.paging = {
                total_rows: n,
                pageCount: l
            }, e.content.find(".it-datatable-pagination-show").html(o), e.content.find(".it-datatable-pagination-count").html(n), 
            ...
            for (let n = 0; n < t.rows.length; n++) {
                ...
                for (let t = 0; t < e.settings.columns.length; t++) {
                    ...
                    l.on("click", function() {
                        n.editor && n.editor.editable && !$(this).find(".it-selected-edit").length && (l.attr("data-oldval", a), 
                        l.find("div").addClass("it-selected-edit").empty(), (o = IT.Utils.createObject(n.editor)).input.on("blur", function() {
                            o.validate() && (l.find("div.it-selected-edit").removeClass("it-selected-edit"), 
                            a = o.val(), l.find("div").html(a), o.content.remove());
                        }), o.renderTo(l.find("div")), o.val(a), o.input.focus());
                    }), i.append(l);
                }
    ...
    constructor(t) {
        ...
        if (e.content = $(n), e.content.find(".it-messagebox-container").css($.extend(e.settings.css, {
            ...
            "function" != typeof (n = $.extend({
                xtype: "button"
            }, n)).renderTo && (n = createObject(n)), n.renderTo(e.content.find(".it-messagebox-btn"));
        });
