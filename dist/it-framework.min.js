...
!function(t) {
        ...
        switch (e.settings.type) {
            ...
            e.params = n, e.empty(), $.ajax({
                ...
                success: function(t) {
                    void 0 !== t.rows && void 0 !== t.total_rows ? ($.each(t.rows, (t, n) => {
                        let a = new IT.RecordStore(n);
                        a.commited = !0, e.data.push(a);
          ...
          case "array":
            ...
            void 0 === a || a ? void 0 !== e.settings.data ? ($.each(e.settings.data, (t, n) => {
                let a = new IT.RecordStore(n);
                a.commited = !0, e.data.push(a), e.total_rows++;
    ...
    addRow(t = {}) {
        let e = this, n = $("<tr>");
        for (let a = 0; a < e.settings.columns.length; a++) {
            let s = e.editors[a], i = e.settings.columns[a], o = i.dataIndex, l = t.get(o);
            s && (s = s.isClass ? s : IT.Utils.createObject($.extend(!0, {}, i.editor, {
                width: i.width
            })));
            let d = i.data || i.renderer || (s && s.store ? s.store.getRawData() : null) || [], r = IT.Utils.findData(l, d), c = $("<td />", {
                html: $("<div />", {
                    html: "" == r ? l : r
                }),
                valign: i.valign || "top",
            ...
            s && "checkbox" == s.className && (c.find("div").empty(), s.addEvents({
                onChange: function() {
                    t.update(o, s.checked), c[t.isChanged(o) ? "addClass" : "removeClass"]("it-datatable-changed");
                }
            }), s.checked = !!l, s.renderTo(c.find("div"))), c.on("click", function() {
                e.selectedRow = c.parent().index(), e.selectedColumn = c.index(), e.content.find("tbody tr").removeClass("it-datatable-selected"), 
                c.parent().addClass("it-datatable-selected"), s && "checkbox" !== s.className && i.editor.editable && !c.hasClass("it-datatable-editing") && !t.isLocked(o) && (c.find("div").empty(), 
                c.addClass("it-datatable-editing"), s.val(t.getChanged(o) || t.get(o)), s.input.on("blur", function() {
                    s.validate() && (t.update(o, s.val()), s.input.off(), s.content.detach(), c.removeClass("it-datatable-editing"), 
                    c.find("div").html(IT.Utils.findData(t.getChanged(o) || t.get(o), d)), c[t.isChanged(o) ? "addClass" : "removeClass"]("it-datatable-changed"));
                }), s.renderTo(c.find("div")), s.input.focus());
            }), n.append(c);
        }
    ...
    removeRow(t = -1) {
        let e = this;
        t = t < 0 ? e.selectedRow : t, e.content.find("tbody>tr").eq(t).remove(), e.selectedRow = null, 
    ...
    constructor(t) {
        ...
        e.elExist = !1, e.settings = $.extend(!0, {
            ...
            cancelable: !1,
            css: {}
        }, t), e.id = e.settings.id || IT.Utils.id(), e.settings.autoShow ? e.show() : e.createElement();
    }
    createElement() {
        let t = this;
        if (!t.elExist) {
            ...
            })), t.content.appendTo("body").hide(), t.elExist = !0, t.settings.autoShow ? t.show() : t.createElement(), 
